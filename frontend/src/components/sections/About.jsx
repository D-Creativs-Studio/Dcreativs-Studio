...
export function About() {
  return (
    <section
      id="about"
      className="relative bg-[#F8F8F6] overflow-hidden py-28 sm:py-36"
    >
      {/* Subtle ambient glow */}
      ...
      <div className="relative z-10 container mx-auto px-6 sm:px-10 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            ...
            <motion.p
              ...
              custom={0}
              className="font-heading text-sm font-semibold tracking-[0.2em] uppercase text-[#4100F5] mb-4"
            >
              Who We Are
            </motion.p>
            ...
            <motion.h2
              ...
              viewport={{ once: true, amount: 0.3 }}
              custom={1}
              className="font-heading text-4xl sm:text-5xl font-extrabold text-[#030412] leading-[1.1] tracking-tight mb-8"
            >
              We build things{" "}
          ...
          >
            {/* Card */}
            <div className="relative rounded-3xl border border-[#030412]/08 bg-[#F7F7FF] shadow-[0_8px_40px_rgba(65,0,245,0.08)] p-8 sm:p-10 overflow-hidden">
              ...
              {/* Stats grid */}
              <div className="relative z-10 grid grid-cols-3 divide-x divide-[#030412]/10 mb-10">
                {stats.map(({ value, label }, i) => (
                  ...
                  >
                    <p className="font-heading text-3xl sm:text-4xl font-extrabold bg-gradient-to-br from-[#4100F5] to-[#885FFF] bg-clip-text text-transparent">
                      {value}
                    </p>
                    <p className="font-body text-xs sm:text-sm text-slate-500 mt-1 leading-snug">
                      {label}
                    </p>
                  </motion.div>
                ))}
              ...
              <div className="relative z-10 flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tag}
                    className="px-3 py-1.5 rounded-full text-xs font-heading font-medium
