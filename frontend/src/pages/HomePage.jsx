      ...
      <BackgroundPaths 
        title={
          <span className="flex flex-col items-center justify-center gap-1 sm:gap-2">
            ...
            <span className="text-5xl min-[360px]:text-6xl min-[390px]:text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] font-extrabold text-white drop-shadow-[0_0_35px_rgba(255,255,255,0.2)]">Noticed.</span>
          </span>
        }
